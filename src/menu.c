...
void init_menu(void)
{
    ...
    */
    ...
    //on
    menu_add_entry(furnituretex_menu, localeText[64], MENU_ID_FURNITURE_ON,localeText[461]);
    //off
    menu_add_entry(furnituretex_menu, localeText[65], MENU_ID_FURNITURE_OFF,localeText[461]);
    //< back
